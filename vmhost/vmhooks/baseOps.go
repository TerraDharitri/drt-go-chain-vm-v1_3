...
// extern int32_t		v1_3_transferDCDT(void *context, int32_t dstOffset, int32_t tokenIDOffset, int32_t tokenIdLen, int32_t valueOffset, long long gasLimit, int32_t dataOffset, int32_t length);
// extern int32_t		v1_3_transferDCDTExecute(void *context, int32_t dstOffset, int32_t tokenIDOffset, int32_t tokenIdLen, int32_t valueOffset, long long gasLimit, int32_t functionOffset, int32_t functionLength, int32_t numArguments, int32_t argumentsLengthOffset, int32_t dataOffset);
// extern int32_t		v1_3_transferDCDTNFTExecute(void *context, int32_t dstOffset, int32_t tokenIDOffset, int32_t tokenIdLen, int32_t valueOffset, long long nonce, long long gasLimit, int32_t functionOffset, int32_t functionLength, int32_t numArguments, int32_t argumentsLengthOffset, int32_t dataOffset);
...
// extern int32_t		v1_3_getDCDTValue(void *context, int32_t resultOffset);
// extern int32_t		v1_3_getDCDTTokenName(void *context, int32_t resultOffset);
// extern long long	v1_3_getDCDTTokenNonce(void *context);
// extern int32_t		v1_3_getDCDTTokenType(void *context);
// extern long long v1_3_getCurrentDCDTNFTNonce(void *context, int32_t addressOffset, int32_t tokenIDOffset, int32_t tokenIDLen);
...
// extern int32_t		v1_3_getDCDTBalance(void *context, int32_t addressOffset, int32_t tokenIDOffset, int32_t tokenIDLen, long long nonce, int32_t resultOffset);
// extern int32_t		v1_3_getDCDTNFTNameLength(void *context, int32_t addressOffset, int32_t tokenIDOffset, int32_t tokenIDLen, long long nonce);
// extern int32_t		v1_3_getDCDTNFTAttributeLength(void *context, int32_t addressOffset, int32_t tokenIDOffset, int32_t tokenIDLen, long long nonce);
// extern int32_t		v1_3_getDCDTNFTURILength(void *context, int32_t addressOffset, int32_t tokenIDOffset, int32_t tokenIDLen, long long nonce);
// extern int32_t		v1_3_getDCDTTokenData(void *context, int32_t addressOffset, int32_t tokenIDOffset, int32_t tokenIDLen, long long nonce, int32_t valueOffset, int32_t propertiesOffset, int32_t hashOffset, int32_t nameOffset, int32_t attributesOffset, int32_t creatorOffset, int32_t royaltiesOffset, int32_t urisOffset);
//
...
import (
	...
	"github.com/TerraDharitri/drt-go-chain-vm-v1_3/wasmer"
)
...
func BaseOpsAPIImports() (*wasmer.Imports, error) {
	...
	imports, err = imports.Append("transferDCDTExecute", v1_3_transferDCDTExecute, C.v1_3_transferDCDTExecute)
	if err != nil {
		return nil, err
	}

	imports, err = imports.Append("transferDCDTNFTExecute", v1_3_transferDCDTNFTExecute, C.v1_3_transferDCDTNFTExecute)
	if err != nil {
		return nil, err
	}

	imports, err = imports.Append("transferDCDT", v1_3_transferDCDT, C.v1_3_transferDCDT)
	if err != nil {
		return nil, err
	}
	...
	imports, err = imports.Append("getDCDTValue", v1_3_getDCDTValue, C.v1_3_getDCDTValue)
	if err != nil {
		return nil, err
	}

	imports, err = imports.Append("getDCDTTokenName", v1_3_getDCDTTokenName, C.v1_3_getDCDTTokenName)
	if err != nil {
		return nil, err
	}

	imports, err = imports.Append("getDCDTTokenType", v1_3_getDCDTTokenType, C.v1_3_getDCDTTokenType)
	if err != nil {
		return nil, err
	}

	imports, err = imports.Append("getDCDTTokenNonce", v1_3_getDCDTTokenNonce, C.v1_3_getDCDTTokenNonce)
	if err != nil {
		return nil, err
	}

	imports, err = imports.Append("getCurrentDCDTNFTNonce", v1_3_getCurrentDCDTNFTNonce, C.v1_3_getCurrentDCDTNFTNonce)
	if err != nil {
		return nil, err
	}
	...
	imports, err = imports.Append("getDCDTBalance", v1_3_getDCDTBalance, C.v1_3_getDCDTBalance)
	if err != nil {
		return nil, err
	}

	imports, err = imports.Append("getDCDTTokenData", v1_3_getDCDTTokenData, C.v1_3_getDCDTTokenData)
	if err != nil {
		return nil, err
	}

	imports, err = imports.Append("getDCDTNFTNameLength", v1_3_getDCDTNFTNameLength, C.v1_3_getDCDTNFTNameLength)
	if err != nil {
		return nil, err
	}

	imports, err = imports.Append("getDCDTNFTAttributeLength", v1_3_getDCDTNFTAttributeLength, C.v1_3_getDCDTNFTAttributeLength)
	if err != nil {
		return nil, err
	}

	imports, err = imports.Append("getDCDTNFTURILength", v1_3_getDCDTNFTURILength, C.v1_3_getDCDTNFTURILength)
	if err != nil {
		return nil, err
	}
...
//export v1_3_getDCDTBalance
func v1_3_getDCDTBalance(
	context unsafe.Pointer,
	addressOffset int32,
	tokenIDOffset int32,
	tokenIDLen int32,
...
//export v1_3_getDCDTNFTNameLength
func v1_3_getDCDTNFTNameLength(
	context unsafe.Pointer,
	addressOffset int32,
	tokenIDOffset int32,
	tokenIDLen int32,
...
//export v1_3_getDCDTNFTAttributeLength
func v1_3_getDCDTNFTAttributeLength(
	context unsafe.Pointer,
	addressOffset int32,
	tokenIDOffset int32,
	tokenIDLen int32,
...
//export v1_3_getDCDTNFTURILength
func v1_3_getDCDTNFTURILength(
	context unsafe.Pointer,
	addressOffset int32,
	tokenIDOffset int32,
	tokenIDLen int32,
...
//export v1_3_getDCDTTokenData
func v1_3_getDCDTTokenData(
	context unsafe.Pointer,
	addressOffset int32,
	tokenIDOffset int32,
	tokenIDLen int32,
...
//export v1_3_transferDCDT
func v1_3_transferDCDT(
	context unsafe.Pointer,
	destOffset int32,
	tokenIDOffset int32,
	tokenIDLen int32,
...
//export v1_3_transferDCDTExecute
func v1_3_transferDCDTExecute(
	context unsafe.Pointer,
	destOffset int32,
	tokenIDOffset int32,
	tokenIDLen int32,
	...
	return v1_3_transferDCDTNFTExecute(context, destOffset, tokenIDOffset, tokenIDLen, valueOffset, 0,
		gasLimit, functionOffset, functionLength, numArguments, argumentsLengthOffset, dataOffset)
}

//export v1_3_transferDCDTNFTExecute
func v1_3_transferDCDTNFTExecute(
	context unsafe.Pointer,
	destOffset int32,
	tokenIDOffset int32,
	tokenIDLen int32,
	...
	host := vmhost.GetVMHost(context)
	return TransferDCDTNFTExecuteWithHost(
		host,
		destOffset,
		tokenIDOffset,
		tokenIDLen,
...
func TransferDCDTNFTExecuteWithHost(
	host vmhost.VMHost,
	destOffset int32,
	tokenIDOffset int32,
	tokenIDLen int32,
...
func TransferDCDTNFTExecuteWithTypedArgs(
	...
	gasLimitForExec, executeErr := output.TransferDCDT(dest, sender, dcdtTokenName, uint64(nonce), dcdtValue, contractCallInput)
	if vmhost.WithFaultAndHost(host, executeErr, runtime.BaseOpsErrorShouldFailExecution()) {
		return 1
	}
...
//export v1_3_getDCDTValue
func v1_3_getDCDTValue(context unsafe.Pointer, resultOffset int32) int32 {
	runtime := vmhost.GetRuntimeContext(context)
	metering := vmhost.GetMeteringContext(context)
...
//export v1_3_getDCDTTokenName
func v1_3_getDCDTTokenName(context unsafe.Pointer, resultOffset int32) int32 {
	runtime := vmhost.GetRuntimeContext(context)
	metering := vmhost.GetMeteringContext(context)
...
//export v1_3_getDCDTTokenNonce
func v1_3_getDCDTTokenNonce(context unsafe.Pointer) int64 {
	runtime := vmhost.GetRuntimeContext(context)
	metering := vmhost.GetMeteringContext(context)
...
//export v1_3_getCurrentDCDTNFTNonce
func v1_3_getCurrentDCDTNFTNonce(context unsafe.Pointer, addressOffset int32, tokenIDOffset int32, tokenIDLen int32) int64 {
	runtime := vmhost.GetRuntimeContext(context)
	metering := vmhost.GetMeteringContext(context)
	storage := vmhost.GetStorageContext(context)
...
//export v1_3_getDCDTTokenType
func v1_3_getDCDTTokenType(context unsafe.Pointer) int32 {
	runtime := vmhost.GetRuntimeContext(context)
	metering := vmhost.GetMeteringContext(context)
