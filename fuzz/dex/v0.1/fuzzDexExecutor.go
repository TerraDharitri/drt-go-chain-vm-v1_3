...
import (
	...
	am "github.com/TerraDharitri/drt-go-chain-vm-v1_3/scenarioexec"
	...
	mjparse "github.com/TerraDharitri/drt-go-chain-vm-v1_3/scenarios/json/parse"
	mjwrite "github.com/TerraDharitri/drt-go-chain-vm-v1_3/scenarios/json/write"
)
...
func (pfe *fuzzDexExecutor) fullOfDcdtWalletString() string {
	...
	dcdtString += fmt.Sprintf(`
						"str:%s": "1,000,000,000,000,000,000,000,000,000,000",`, pfe.moaTokenId)
	dcdtString += fmt.Sprintf(`
